...
// carIndex = inventory.findIndex(inventory.id === 33);
...
console.log("\nThe last car is a " + lastCar.car_make + " " + lastCar.car_model);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console

let carModels = inventory.map(inventory=>inventory.car_model);  // carModels is an array containing only the model names
let carModelsSorted = carModels.sort();

console.log("\nA list of all the car models sorted alphabetically:");
...
console.log("\nHere are all the car years: ")
console.log(carYears);

// ==== Challenge 5 ====
// The car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.

let oldCars = [];   // inventory.filter(inventory=>);
for (car of inventory)
{
  let date = car.car_year;
  if (date < 2000)
    oldCars.push(date);
}

// console.log(oldCars);
console.log(oldCars.length + " of those cars were built before Y2K.");

let uniqueYears = Array.from(new Set(oldCars));
console.log ("They were built in these " + uniqueYears.length + " unique years: " + uniqueYears.sort());
...
console.log ("\nAll the BMW and Audi cars on the lot:")
